      ...
      <div className="flex flex-col xl:flex-row gap-3 justify-start mb-3 ">
        <div className="w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
            {/* total student Chart  */}
            <div className="flex flex-col justify-between box-content !p-3 ">
              <h2 className="text-lg pt-3 font-bold">Total Steudents</h2>
            ...
            {/* Courses Chart  */}
            <div className="flex flex-col justify-between box-content flex-1 !p-3">
              <h2 className="text-lg py-3 font-bold">Courses</h2>
            ...
            {/* Prepaid Chart  */}
            <div className="flex flex-col justify-between box-content flex-1 !p-3">
              <h2 className="text-xl pt-3 font-bold">Prepaid</h2>
          ...
          <div className="box-content flex-1 !p-3">
            <div className="flex flex-col md:flex-row ">
              <div className="w-[170px] p-4">
                <h2 className="text-2xl font-semibold mb-1 ">Earnings</h2>
                <span className="block text-secondary mb-4 text-sm">
                  Dec 1 - Dec 31, 2021
                </span>
                <span className="block mb-2 text-sm">This Month</span>
                <h1 className="text-3xl font-bold mb-3">$53.678</h1>
                <span className="flex gap-2 items-center">
                  <CircleArrowUp className="text-[#3269D3]" size={18} />
                  <span className="text-xs text-[#3269D3]">+15%</span>
                </span>
              </div>
        ...
        {/* Today student List   */}
        <div className="box-content  xl:w-[450px]">
          <h1 className="text-xl font-bold mb-4 ">Today Student List</h1>
          <div>
