    ...
    >
      ...
      <div className="p-4 border rounded-lg my-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <div className="flex flex-col justify-center items-center gap-2 p-6 border rounded-lg sm:items-center">
            <span className="text-secondary text-sm">Last Payout</span>
            <h3 className="text-lg font-bold">$980.50</h3>
            <span className="text-xs text-secondary">April 1, 2025</span>
          </div>
          <div className="flex flex-col justify-center items-center gap-2 p-6 border rounded-lg sm:items-center">
            <span className="text-secondary text-sm">Next Payout</span>
            <h3 className="text-lg font-bold">$1,245.00</h3>
            <span className="text-xs text-secondary">May 1, 2025</span>
          </div>
        </div>
      </div>
