  ...
  return (
    <div className="relative">
      ...
      <div ref={AlertMenuRef}>
        ...
        {/* Dropdown Menu */}
        {isAlertMenuOpen && (
          <div className="box-content absolute top-12 -right-16 md:right-0 w-[280px] md:w-[400px] rounded-md min-h-[100px] p-4">
            {notification.length ? (
              <div>
                  ...
                  <div
                    ...
                    <div>
                      <Link
                        ...
                        className="flex items-center text-xs font-medium text-light-primary hover:text-primary">
              ...
              <div className="flex justify-center items-center h-[400px] w-full">
                <div className="flex flex-col items-center">
                  <div className="flex justify-center items-center w-28 h-28 bg-[#eee] rounded-full mb-6">
                    <BellRing className="text-secondary" size={40} />
                  </div>
