  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <div className=" box-content w-full ">
        <Quote size={30} className=" text-light-primary" />
        <p className="text-gray-700 p-6">{quote}</p>
        <span className="block text-center w-full text-secondary">
          {number}
        </span>
      </div>
      ...
      <div className="flex space-x-2">
        ...
        <button
          onClick={handleNext}
          className="bg-light-primary text-white rounded p-2 hover:bg-light-primary">
          <ChevronRight />
        </button>
      </div>
    </div>
